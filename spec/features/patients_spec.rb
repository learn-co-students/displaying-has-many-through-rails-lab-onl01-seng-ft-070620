...
describe 'patients', type: :feature do
  before do
    ...
    Appointment.create([
                         { appointment_datetime: DateTime.new(2016, 0o3, 15, 18, 0o0, 0), patient_id: 1, doctor_id: 2 },
                         { appointment_datetime: DateTime.new(2016, 0o1, 11, 20, 20, 0), patient_id: 2, doctor_id: 1 },
                         { appointment_datetime: DateTime.new(2016, 0o4, 22, 14, 0o0, 0), patient_id: 3, doctor_id: 5 },
                         { appointment_datetime: DateTime.new(2017, 10, 30, 15, 0o0, 0), patient_id: 4, doctor_id: 4 },
                         { appointment_datetime: DateTime.new(2016, 0o7, 11, 16, 0o0, 0), patient_id: 5, doctor_id: 3 },
                         { appointment_datetime: DateTime.new(2016, 0o5, 31, 17, 0o0, 0), patient_id: 1, doctor_id: 2 },
                         { appointment_datetime: DateTime.new(2017, 0o6, 0o3, 10, 0o0, 0), patient_id: 3, doctor_id: 1 }
                       ])
